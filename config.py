...
class Config:
    ...
    # Temp Directory for Git Clone
    temp_dir: str = "/tmp/rca_git_cache"
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            temp_dir=os.getenv("RCA_TEMP_DIR", "/tmp/rca_git_cache"),
        )
    ...
    def from_databricks_secrets(cls, scope: str = "rca-secrets") -> "Config":
        ...
        try:
            ...
            print(f"Warning: Could not load from Databricks secrets: {e}")
